// `you-park webhook verify` — local cryptographic verification of a
// YouPark outbound webhook delivery (Task 0106).
//
...
//     command is usable on a fresh install with no `you-park login`.
