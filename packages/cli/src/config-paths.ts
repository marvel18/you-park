...
//   - `~/.config/you-park/credentials.json` (0600)
//   - `~/.config/you-park/config.json`     (0644)
//
// Override via `YOU_PARK_CONFIG_DIR` (used heavily by tests).
...
export function resolveConfigDir(): string {
  ...
  // the dir they expect; fall back to `~/.config/you-park` everywhere
