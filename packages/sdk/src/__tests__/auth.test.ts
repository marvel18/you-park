...
//   - YouParkError hierarchy propagation with request-id passthrough
...
function client(fetchImpl: typeof fetch): YouPark {
  return new YouPark({ baseUrl: "https://api.test", fetch: fetchImpl });
}
...
describe("AuthClient", () => {
  ...
  it("client.auth is wired onto the YouPark class", () => {
