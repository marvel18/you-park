// Typed error hierarchy for the YouPark SDK.
//
...
// codes (forward compatibility) fall back to the generic `YouParkError`
...
export interface YouParkErrorInit {
 ...
 * `quota_exceeded`) decode to this class — `instanceof YouParkError`
 * still matches.
 */
export class YouParkError extends Error {
  ...
  constructor(init: YouParkErrorInit) {
    super(init.envelope.message);
    this.name = "YouParkError";
...
export class BadRequestError extends YouParkError {
  constructor(init: YouParkErrorInit) {
    super(init);
...
export class UnauthenticatedError extends YouParkError {
  constructor(init: YouParkErrorInit) {
    super(init);
...
export class ForbiddenError extends YouParkError {
  constructor(init: YouParkErrorInit) {
    super(init);
...
export class NotFoundError extends YouParkError {
  constructor(init: YouParkErrorInit) {
    super(init);
...
export class ConflictError extends YouParkError {
  constructor(init: YouParkErrorInit) {
    super(init);
...
export class ValidationError extends YouParkError {
...
export class PreconditionFailedError extends YouParkError {
  constructor(init: YouParkErrorInit) {
    super(init);
...
export class UnsupportedError extends YouParkError {
  constructor(init: YouParkErrorInit) {
    super(init);
...
export class InternalError extends YouParkError {
  constructor(init: YouParkErrorInit) {
    super(init);
...
export interface RateLimitErrorInit extends YouParkErrorInit {
...
export class RateLimitError extends YouParkError {
...
/**
 * Decode an HTTP `Response` into the appropriate `YouParkError` subclass.
 *
 * Forward-compatible: unknown error codes resolve to the base `YouParkError`.
...
export async function decodeError(
  ...
  switch (envelope.code as ErrorCode) {
    ...
    default:
      ...
      return new YouParkError(init);
  }
}

function decodeRateLimit(
  init: YouParkErrorInit,
  response: Response,
): RateLimitError {
