 ...
 * signature verifier for YouPark outbound webhook deliveries.
 *
...
/**
 * Compute the canonical YouPark webhook signature for a payload.
...
/**
 * Verify the HMAC-SHA256 signature of a YouPark webhook delivery.
 *
